        ...
        eStorage.getItem(guideline_var,function(rs){
            if(rs==null || rs==false){
                var html = $("<div class='cmnw first-use'>" +
                    "first-use [Options] <img src='http://farm9.staticflickr.com/8093/8580046762_9d6659f48f_m.jpg'/>" +
                    "<a href='javascript:void(0)' class='btn confirm'>Confirm</a>" +
                    "<a href='javascript:void(0)' class='btn ignore'>Ignore</a>" +
                    "</div>")
                function close(){
